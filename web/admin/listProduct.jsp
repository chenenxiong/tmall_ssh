        ...
        <div class="panel-body">
            <form method="post" id="addForm" action="admin_product_add">
                <table class="addTable">
                    ...
                    <tr>
                        <td>原价格</td>
                        <td><input id="originalPrice" value="" name="product.originalPrice" type="text"
                                   class="form-control"></td>
                    </tr>
                    <tr>
                        <td>优惠价格</td>
                        <td><input id="promotePrice"  value="" name="product.promotePrice" type="text"
                                   class="form-control"></td>
                    </tr>
                    <tr>
                        <td>库存</td>
                        <td><input id="stock"  value="" name="product.stock" type="text"
                                   class="form-control"></td>
                    </tr>
                    <tr class="submitTR">
